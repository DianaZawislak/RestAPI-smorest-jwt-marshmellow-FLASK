...
class Config(object):
    ...
    API_SPEC_OPTIONS = {
        'info': {'description': 'This is my sample server for  [flask_smorest]('
                                'https://flask-smorest.readthedocs.io/en/latest/).'
                                
                 'Cities and countries are based on one csv file and breweries and beers on a different one'
                 'I am using SQLite, SQLAlchemy relational database for this example',
